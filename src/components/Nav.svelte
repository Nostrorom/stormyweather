...
<nav class="flex fixed top-0 z-30 w-screen bg-gradient-to-l from-indigo-900 via-lightBlue-700 to-cyan-600">
	<div class="w-full mx-auto navItems flex items-center justify-between">
